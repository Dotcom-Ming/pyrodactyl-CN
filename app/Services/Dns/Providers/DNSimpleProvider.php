...
class DNSimpleProvider implements DnsProviderInterface
{
    ...
    public function getConfigurationSchema(): array
    {
        return [
            'api_token' => [
                'type' => 'string',
                'required' => true,
                'description' => trans('dns.schema.dnsimple.api_token'),
                'sensitive' => true,
            ],
            'account_id' => [
                'type' => 'string',
                'required' => false,
                'description' => trans('dns.schema.dnsimple.account_id'),
                'sensitive' => false,
            ],
        ];
    }
    ...
    private function getAccountId(): string
    {
        ...
        if (!isset($data['data']['account']['id'])) {
            throw new \Exception(trans('dns.errors.account_id_unavailable'));
        }
