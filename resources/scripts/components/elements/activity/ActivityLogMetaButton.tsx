...
const ActivityLogMetaButton = ({ meta }: { meta: Record<string, unknown> }) => {
    ...
    return (
        <>
            <Dialog open={open} onClose={() => setOpen(false)} hideCloseIcon title={t('strings.event_metadata')}>
                <div className='space-y-4'>
                    <div className='flex items-center justify-between'>
                        <h4 className='text-sm font-medium text-zinc-300'>{t('strings.formatted_view')}</h4>
                        <ActionButton
                            variant='secondary'
                        ...
                        >
                            ...
                            {copied ? t('strings.copied') : t('strings.copy_json')}
                        </ActionButton>
                    </div>
                    ...
                    <div>
                        <h4 className='text-sm font-medium text-zinc-300 mb-2'>{t('strings.raw_json')}</h4>
            ...
            <button
                aria-label={t('strings.view_event_metadata')}
