            ...
            <div>
                ...
                <div className='relative my-6'>
                    ...
                    <div className='relative flex justify-center text-zinc-400 uppercase text-sm tracking-wider'>
                        <span className='bg-zinc-900 px-5'>{t('server.hytale_or_enter_code_manually')}</span>
                    </div>
                </div>

                <div className='bg-zinc-900 border border-zinc-700 rounded p-4 text-center'>
                    <div className='text-zinc-400 text-sm mb-2'>{t('server.hytale_device_code')}</div>
                    {userCode ? (
                        <div
                ...
                <p className='text-zinc-500 text-xs text-center mt-4'>{t('server.hytale_once_per_server')}</p>
            </div>
        </Modal>
    );
};
