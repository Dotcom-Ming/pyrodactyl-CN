...
return [
    ...
    'allocations' => [
        ...
        'delete_default_no_fallback' => '您正在尝试删除此服务器的默认分配，但没有可用的备用分配。',
        'parse_ip_failed' => '无法解析提供的分配 IP 地址（:ip）：:error',
        'invalid_ip_generated' => '生成的 IP 地址无效：:ip',
    ],
    'nest' => [
        ...
        'variables' => [
            ...
            'protected_name' => '不能将受保护的名称 :name 用作此环境变量。',
        ...
        'importer' => [
            ...
            'selected_file_invalid' => '所选文件无效，无法导入。',
        ],
    ],
    'subusers' => [
    ...
    'tasks' => [
        ...
        'invalid_cron' => '提供的 Cron 数据无法计算为有效表达式。',
        'no_tasks' => '无法处理计划任务执行：未注册任何任务。',
    ...
    'api' => [
        ...
        'requested_resource_missing' => '请求的资源在系统中不存在。',
        'invalid_json' => '请求中传入的 JSON 数据格式错误：:error',
        'invalid_authorization_header' => '提供的 Authorization 请求头格式无效。',
        'daemon_access_denied' => '您无权访问此资源。',
        'acl_required' => 'API 请求必须定义 ACL 资源。',
    ...
    'backup' => [
        ...
        'cannot_complete_missing_upload_id' => '无法完成备份请求：模型中没有 upload_id。',
        'invalid_multipart_parts' => '提供的分片上传完成数据无效。',
        'multipart_parts_missing' => '未找到用于完成分片上传的分片。',
        'server_access_denied' => '您没有访问该服务器的权限。',
    ...
    'server' => [
        ...
        'not_transferring' => '服务器当前未处于转移状态。',
        'resource_not_found' => '请求参数中未找到服务器资源。',
        'install_state_forbidden' => '由于当前安装状态，不允许访问此资源。',
    ],
    'mail' => [
        'smtp_only' => '此功能仅在面板选择 SMTP 邮件驱动时可用。',
    ],
    'websocket' => [
