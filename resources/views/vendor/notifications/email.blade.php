                                ...
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        <h1 style="{{ $style['header-1'] }}">
                                            ...
                                            @else
                                                @if ($level == 'error')
                                                    {{ trans('notifications.template.greeting_error') }}
                                                @else
                                                    {{ trans('notifications.template.greeting_default') }}
                                                @endif
                                            @endif
                                        </h1>
                                                ...
                                                <tr>
                                                    <td style="{{ $fontFamily }}">
                                                        <p style="{{ $style['paragraph-sub'] }}">
                                                            {{ trans('notifications.template.trouble_clicking', ['action' => $actionText]) }}
                                                        </p>
                                ...
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                        <p style="{{ $style['paragraph-sub'] }}">
                                            ...
                                            {{ trans('notifications.template.all_rights_reserved') }}
                                        </p>
                                    </td>
                                </tr>
                            </table>
